...
export default new LocalizedStrings({
  en: {
    ...
    FinishOrder:
      "Thank you for your purchase, As soon as we can assign a driver your request will become a live, trackable order and we will notify you, then redirect you to the tracking screen.",
    NextStep: "NEXT STEP",
    ...
    Payment: "Payment",
    Complete: "Complete",
    EnterYourfirst_name: "Enter your First Name",
    ...
    // Place holder
    Typefirst_name: "Type your first name",
    ...
    RegisterAsStore: "Register As Store",
  ...
  ar: {
    ...
    Payment: "دفع",
    Complete: "دفع...",
    EnterYourfirst_name: "أدخل اسمك الأول",
    ...
    // Place holder
    Typefirst_name: "اكتب اسمك الأول",
    ...
    // Horizontal
    partyPacks: "منتجات مميزة",
    beerAndSmokes: "تشكيلة الحقائب",
    wine: "افضل مبيعات منتجات المرأة",
