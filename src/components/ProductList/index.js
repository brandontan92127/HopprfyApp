...
import { Constants, Languages, withTheme, GlobalStyle, Device } from "@common";
...
class ProductList extends Component {
  ...
  render() {
    ...
    return (
      <View style={[styles.listView, {paddingTop: Device.getCorrectIphoneXViewBasePadding(30), backgroundColor: GlobalStyle.primaryBackgroundColor.color}]}>
        <AnimatedHeader
