...
class StoreHome extends Component {
  constructor(props) {
    ...
    this.navigateToStockScreen = () => {
      ...
      navigation.navigate('ProductStocksScreen');
    };
      ...
      return (
        <View style={{paddingTop: 4, marginTop: 13}}>
          <TouchableHighlight onPress={() => this.refs.modal2.open()}>
            <FastImage source={Images.Open1} style={{height: 26, width: 26}} />
          </TouchableHighlight>
        </View>
      );
    } else {
  ...
  cancelOrder = async orderId => {
    await HopprWorker.storeCancelOrder(orderId, 'Test reason');
  };
        ...
        <ListItem
          ...
          rightIcon={
            <View
              ...
              <Image
                source={require('../../../assets/icons/DriverStore.png')}
                style={{width: 25, height: 25, tintColor: '#AFBECD'}}
              />
              <Text style={{fontSize: 12, color: '#AFBECD'}}>STORE</Text>
            </View>
          }
            ...
            <MapView
              ...
              <Marker
                ...
                <FastImage
                  ...
                  style={{width: 70, maxWidth: 70, height: 70}}
                />
              </Marker>
            </MapView>
          </View>
