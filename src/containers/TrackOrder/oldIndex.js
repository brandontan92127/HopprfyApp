...
const initalState = {
  ...
  stores: [],
  drivers: [],
  orderStateImage: Images.HopprLogoPlaceholder,
  orderStageText: 'no order is active',
...
class TrackOrderScreen extends Component {
    ...
    this.renderCountdown = () => {
      try {
        ...
        if (this.state.activeCustomerOrder.length > 0) {
          ...
          let thaId = '' + Date.now();
          let otherid = 'id_' + timeToDeliveryInSeconds;
          toast('id set as:' + otherid);

          // let randomRounded = Math.round(rnd);
          // let randomId = "id_" + randomRounded;
          // toast("random id set as:" + randomId);

          return (
            <CountDown
              ref={el => (this._countdownTimer = el)}
              until={timeToDeliveryInSeconds}
              digitStyle={{
              ...
              timeLabelStyle={{color: hotPink, fontWeight: 'bold'}}
          ...
          return (
            <CountDown
              ...
              timeLabelStyle={{color: mainBlue, fontWeight: 'bold'}}
              separatorStyle={{color: mainBlue}}
              showSeparator
              timeToShow={['H', 'M', 'S']}
              timeLabels={{h: 'HH', m: 'MM', s: 'SS'}}
        ...
        console.debug('countdown crashed');
      }
    };
  ...
  _renderCornerLogoImage = () => {
    let imgSrc = Images.HopprLogoPlaceholderPink;
  ...
  componentDidUpdate = async (prevProps, prevState) => {
    ...
    if (typeof this.state.selectedCustomerOrder !== 'undefined') {
      let whichStageOfOrderText = 'no order is active';
      ...
      switch (this.state.selectedCustomerOrder.state) {
        case 'DRIVER_EN_ROUTE_TO_STORE':
          whichStageOfOrderText = 'until order pickup';
        ...
        case 'ORDER_EN_ROUTE_TO_CUSTOMER':
          whichStageOfOrderText = 'until order delivery';
          ...
          break;
        default:
          whichStageOfOrderText = 'no order is active';
          whichStageOfOrderText2 = 'None';
          currentProgressState = 0.0;
          whichImage = Images.HopprLogoPlaceholder;
          orderStageText2Padding = -28;
          break;
      }
      ...
      if (this.state.selectedCustomerOrder.driverMarkedAsComplete) {
        whichStageOfOrderText = 'order was delivered';
  ...
  _resolveTimeToDeliveryPayload = (driver, order, store) => {
    ...
    if (driver.state === 'ON_DELIVERY_ORDER_PICKUP') {
    ...
    else if (driver.state === 'ON_DELIVERY_OUT_FOR_DELIVERY') {
      payloadToReturn.startLat = driver.location.lat;
      payloadToReturn.startLng = driver.location.long;
    ...
    if (
      ...
      return Platform.OS === 'android' ? (
        <Marker
          ...
          <FastImage
            source={Images.HopprLogoMapPin1Filled}
            style={{
              width: 55,
              maxWidth: 90,
              minHeight: 70,
        ...
        <Marker.Animated
          ...
          <Callout
            ...
            <View>
              <Text style={{fontSize: 18}}>{'Order destination'}</Text>
              <Text style={{color: 'silver', fontSize: 12}}>
                {this.state.destinationAddressText}
              </Text>
            </View>
          ...
          <FastImage
            source={Images.HopprLogoMapPin2Filled}
            style={{
              width: 55,
              maxWidth: 90,
              minHeight: 70,
    ...
    return (
      <View
        ...
        <Header
          ...
          //     try {
          //       if (this.state.selectedCustomerOrderId != -1) {
          //         this._updateSelectedNetwork(this.state.selectedCustomerOrder.networkId)
          //         this._openFullOrderModal();
          //       }
          //     } catch (error) {
          //       console.debug(error);
          ...
          // showMessage({
          //   message: "This is the track order screen",
          //   description:
          //     "If you have an in progress order it will be displayed here, along with all relevant details.",
          //   type: "success",
          //   autoHide: false,
          //   backgroundColor: "#ED8C48", // background color
          //   hideOnPress: true
                    ...
                    <View
                      ...
                      <View
                        ...
                        <FastImage
                          ...
                          source={this.state.orderStateImage}
                          //source={Images.AnimatedStore3}
                          resizeMode="contain"
                        />
                        {/* <BlinkView blinking={true} delay={2800}> */}
                        ...
                        <Animatable.Text
                          ...
                          style={{
                            top: this.state.orderStageText2Padding,
                            // color: "lightblue",
                            // textAlign: "center",
                            // fontWeight: "bold",
                            // fontSize: 12,
